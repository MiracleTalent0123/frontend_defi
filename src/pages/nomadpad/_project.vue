...
import { setAnchorProvider, getLaunchpad, getProjectFormatted, getAllProjects, LaunchpadProgram } from '@/utils/crp-launchpad'
...
export default Vue.extend({
  ...
  methods: {
    ...
    goToProject(fertilizer: any) {
      ...
      this.$router.push({
        path: '/nomadpad/_project?project=' + fertilizer.mint 
      })
