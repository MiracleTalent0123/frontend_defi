...
import { NNI_LP_PROGRAM_ID_V1, CRP_LP_VERSION_V1, TOKEN_PROGRAM_ID } from '@/utils/ids'
import { TokenAmount } from '@/utils/safe-math'
import { closeAccount } from '@project-serum/serum/lib/token-instructions'
import { depositInstruction, withdrawInstruction } from './nni-swap'
...
export async function getLpMintListDecimals(
  ...
  console.log("getMultipleAccounts->4", mintAll.length)
